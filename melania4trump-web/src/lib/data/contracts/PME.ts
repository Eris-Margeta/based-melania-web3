...
export const PMEContract: ContractI = {
	MAIN_ADDRESS: "0xEB14eB409E6C8FC3f62Ad80b7865bC04CDB6c8F2",
	ABI: [
		...
		{
			inputs: [
				{ internalType: "uint256", name: "gasForProcessing", type: "uint256" },
			],
			name: "InvalidGasForProcessing",
			type: "error",
		},
		{
		...
		{
			inputs: [
				{ internalType: "uint16", name: "swapThresholdRatio", type: "uint16" },
			],
		...
		{
			inputs: [
				{ internalType: "uint256", name: "tradeCooldownTime", type: "uint256" },
			],
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: "bool", name: "isPair", type: "bool" },
			],
		...
		{
			inputs: [],
			name: "addLiquidityFromLeftoverTokens",
			outputs: [],
			stateMutability: "nonpayable",
			type: "function",
		},
		...
		{
			inputs: [
				{ internalType: "uint256", name: "callbackGas", type: "uint256" },
			],
			name: "callbackGasSetup",
			outputs: [],
			stateMutability: "nonpayable",
			type: "function",
		},
		...
		},
		{
			inputs: [
				{
					internalType: "uint256",
					name: "newGasForProcessing",
					type: "uint256",
				},
			],
			name: "gasForProcessingSetup",
			outputs: [],
			stateMutability: "nonpayable",
			type: "function",
		},
		...
		{
			inputs: [
				{ internalType: "uint16", name: "_buyFee", type: "uint16" },
				{ internalType: "uint16", name: "_sellFee", type: "uint16" },
				{ internalType: "uint16", name: "_transferFee", type: "uint16" },
			],
			name: "liquidityFeesSetup",
			outputs: [],
			stateMutability: "nonpayable",
			type: "function",
		},
		...
		{
			inputs: [
				{ internalType: "uint16", name: "_swapThresholdRatio", type: "uint16" },
			],
